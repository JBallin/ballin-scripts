...
or GitHub CLI; Gist backup setup requires an authenticated active GitHub CLI
account for the selected host and, when newly completed, offers a default-no
choice to run backups after updates.
